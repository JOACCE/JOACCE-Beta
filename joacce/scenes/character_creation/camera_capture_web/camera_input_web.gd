...
# Camera
@onready var camera : Control = $UI/CameraCaptureContainer/HBoxContainer/CameraContainer/WebCamera
...
func _capture_player() -> void:
	...
	var processed = imageProcessing.extractPlayer(imgRaw, imgMask, boundary)
...
func _show_sprite_preview() -> void:
	...
	preview_image.load_png_from_buffer(captured_buffers[curr_stencil])
